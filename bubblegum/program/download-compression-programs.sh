...
pushd solana_program_library/account-compression/programs/account-compression
  ...
  mv ./here/spl_account_compression.so $MPL_ROOT/test-programs/GRoLLzvxpxxu2PGNJMMeZPyMxjAUH9pKqxGXV9DGiceU.so
popd

pushd solana_program_library/account-compression/programs/noop
  cargo build-bpf --bpf-out-dir ./here
  mv ./here/spl_noop.so $MPL_ROOT/test-programs/WRAPYChf58WFCnyjXKJHtrPgzKXgHp6MD9aVDqJBbGh.so
popd
