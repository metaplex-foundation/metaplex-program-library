...
curl -LkSs https://api.github.com/repos/solana-labs/solana-program-library/tarball/b0d84fc44d45786eafdf7e2171bbe9d0e7de916d | tar -xz --strip-components=1 -C ./solana_program_library
