...
#[tokio::test]
async fn auctioneer_cancel_listing() {
...
#[tokio::test]
async fn auctioneer_cancel_listing_missing_scope_fails() {
    let mut context = auction_house_program_test().start_with_context().await;
    // Payer Wallet
    let (ah, ahkey, ah_auth) = existing_auction_house_test_context(&mut context)
        .await
    ...
    // Missing Cancel scope so auctioneer_cancel should fail.
...
#[tokio::test]
async fn auctioneer_cancel_listing_no_delegate_fails() {
    let mut context = auction_house_program_test().start_with_context().await;
...
#[tokio::test]
async fn auctioneer_cancel_bid() {
    let mut context = auction_house_program_test().start_with_context().await;
    let (ah, ahkey, ah_auth) = existing_auction_house_test_context(&mut context)
        .await
        .unwrap();
...
#[tokio::test]
async fn auctioneer_cancel_bid_missing_scope_fails() {
    let mut context = auction_house_program_test().start_with_context().await;
    let (ah, ahkey, ah_auth) = existing_auction_house_test_context(&mut context)
        .await
        .unwrap();
...
#[tokio::test]
async fn auctioneer_cancel_bid_no_delegate_fails() {
    let mut context = auction_house_program_test().start_with_context().await;
    let (ah, ahkey, _) = existing_auction_house_test_context(&mut context)
        .await
        .unwrap();
