...
export class CandyMachineHelper {
  ...
  async mint(
    ...
    const accounts: MintInstructionAccounts = {
      ...
      collectionAuthority: metadataAddress,
      collectionAuthorityRecord: metadataAddress,
      collectionMasterEdition: metadataAddress,
      collectionMetadata: metadataAddress,
      collectionMint: metadataAddress,
      tokenAccount: metadataAddress,
      candyMachine: candyMachine,
