...
pub async fn create_auction_house(
    ...
    let (auctioneer_authority, aa_bump) = find_auctioneer_authority_seeds(auction_house_key);
...
pub fn buy(
    ...
    (
        mpl_auctioneer::accounts::AuctioneerBuy,
...
pub fn execute_sale(
    ...
    (
        mpl_auctioneer::accounts::AuctioneerExecuteSale,
