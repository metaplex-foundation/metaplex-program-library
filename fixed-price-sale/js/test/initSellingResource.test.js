...
(0, tape_1)('init-selling-resource: success', function (t) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, payer, connection, transactionHandler, store, _b, sellingResource, vault, vaultOwner, vaultOwnerBump, resourceMint, metadata;
    return __generator(this, function (_c) {
        switch (_c.label) {
            ...
            case 3:
                _b = _c.sent(), sellingResource = _b.sellingResource, vault = _b.vault, vaultOwner = _b.vaultOwner, vaultOwnerBump = _b.vaultOwnerBump, resourceMint = _b.resourceMint, metadata = _b.metadata;
