...
pub enum MetadataInstruction {
    ...
    #[account(5, writable, signer, name="payer", desc="Update authority")]
    ...
    #[account(9, name="token_record", desc="Token record account")]
    #[account(10, name="system_program", desc="System program")]
    #[account(11, name="sysvar_instructions", desc="Instruction sysvar account")]
    #[account(12, name="spl_token_program", desc="Token Program")]
    #[account(13, optional, name="authorization_rules_program", desc="Token Authorization Rules Program")]
    #[account(14, optional, name="authorization_rules", desc="Token Authorization Rules account")]
    #[default_optional_accounts]
    Migrate(MigrateArgs),
    ...
    #[account(7, optional, writable, name="owner_token_record", desc="Token record account")]
    #[account(8, optional, writable, name="destination_token_record", desc="Token record account")]
