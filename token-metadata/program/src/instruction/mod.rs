...
pub enum MetadataInstruction {
    ...
    #[account(6, optional, writable, name="parent_edition", desc="Master edition token account")]
    #[account(7, optional, name="parent_mint", desc="Master edition mint of the asset")]
    #[account(8, optional, name="parent_token", desc="Master edition token account to close")]
