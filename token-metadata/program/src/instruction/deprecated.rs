...
pub fn create_master_edition(
    ...
    #[allow(deprecated)]
    create_master_edition_with_token_program(
        program_id,
        edition,
        mint,
        update_authority,
...
#[deprecated(
    since = "1.1.0",
    note = "please use `create_master_edition_v3_with_token_program` instead"
)]
pub fn create_master_edition_with_token_program(
    program_id: Pubkey,
    edition: Pubkey,
    mint: Pubkey,
    update_authority: Pubkey,
