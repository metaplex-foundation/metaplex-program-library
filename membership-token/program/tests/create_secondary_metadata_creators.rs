...
mod create_secondary_metadata_creators {
    ...
    async fn success() {
        ...
        let (vault_owner, _vault_owner_bump) =
            mpl_membership_token::utils::find_vault_owner_address(
                &resource_mint.pubkey(),
        ...
        let accounts = mpl_membership_token_accounts::CreateSecondaryMetadataCreators {
        ...
        let data = mpl_membership_token_instruction::CreateSecondaryMetadataCreators {
